...
"""
        ...
        if jobSeekerEducationInfo.isEmpty { labelEmptyEducation.text = "update_this_record".localized() }
        ...
        if jobSeekerWorkExperience.isEmpty { labelEmptyWorkExperience.text = "update_this_record".localized() }
        ...
        if jobSeekerTechnicalSkill.isEmpty { labelEmptyTechSkills.text = "update_this_record".localized() }
        ...
        if jobSeekerTechnicalSkill.isEmpty { labelEmptyAdditionalInfo.text = "update_this_record".localized() }
        ...
        if jobSeekerCertification.isEmpty { labelEmptyCertification.text = "update_this_record".localized() }
